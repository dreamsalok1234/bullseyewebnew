...
export class ProdialogComponent {
  ...
  ngOnInit() {
    document.querySelector('body').classList.add('prodialog-page');
    try {
    ...
    this.subscriptionUrl = this.sanitizer.bypassSecurityTrustResourceUrl(
      this.commonService.globalService.apiBaseUrl+'/subscription?accessToken=' + this.accessToken + '&language=' + this.dectLanguage
    );
  ...
  refreshTranslation() {
    ...
    this.dialogRef.afterClosed().subscribe(result => {
      document.querySelector('body').classList.remove('prodialog-page');
    });
  }
  close() {
  ...
  gotoUpgradeUrl() {
    ...
    if (!this.subCancelBtn) {
      ...
      this.subscriptionUrl = this.sanitizer.bypassSecurityTrustResourceUrl(
        this.commonService.globalService.apiBaseUrl+'/subscription/upgrade?accessToken=' + objectType.accessToken + '&language=' + objectType.dectLanguage
      );
